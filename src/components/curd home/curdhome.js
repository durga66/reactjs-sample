...
export class CurdHome extends React.Component {
  ...
  render() {
    return (
      <div>
            <Button onClick={() => { this.handleModal() }}>Modal Popup</Button>
            <Modal size="lg"
              aria-labelledby="contained-modal-title-vcenter"
              centered show={this.state.show} onHide={() => this.handleModal()}>
              <Modal.Header closeButton>Installation Process</Modal.Header>
              <Modal.Body>
